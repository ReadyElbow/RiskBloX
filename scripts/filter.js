...
function redirect(){
  localStorage.setItem("scoreCap", document.getElementById("scoreCap").selected);
  localStorage.setItem("tolerance", document.getElementById("tolerance").value);
  localStorage.setItem("impactThreshold", document.getElementById("impactThreshold").selected);
