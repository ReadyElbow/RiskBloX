...
def get_techniques(data_source, source_name, groups, malware, tactics, platforms, include_sub_tech):
    '''
...
def do_mapping(data_source, relationship_type, type_filter, source_name, groups, malware, tactics, platforms, include_sub_tech):
    '''
    ...
    all_attack_patterns = get_techniques(data_source, source_name, groups, malware, tactics, platforms, include_sub_tech)
    json_data = {}
    id = 1
...
def main(domain, groups, malware, tactics, platforms, sub_techniques):
    ...
    data = do_mapping(data_source, "mitigates", "course-of-action", source_name, groups, malware, tactics, platforms, sub_techniques)
    return data