...
def get_techniques(data_source, source_name, groups, malware, tactics, platforms, include_sub_tech,includeNonMappedT):
    '''
    ...
    if malware != [""]:
        groupMalwareIds += fetch_groups(data_source, malware, "malware")
    ''' 
...
def do_mapping(data_source, relationship_type, type_filter, source_name, groups, malware, tactics, platforms, include_sub_tech,includeNonMappedT):
    '''
    ...
    filteredAttackPatterns = get_techniques(data_source, source_name, groups, malware, tactics, platforms, include_sub_tech,includeNonMappedT)
    json_data = {}
    id = 1
...
def main(domain, groups, malware, tactics, platforms, sub_techniques,includeNonMappedT):
    ...
    data = do_mapping(data_source, "mitigates", "course-of-action", source_name, groups, malware, tactics, platforms, sub_techniques,includeNonMappedT)
    return data